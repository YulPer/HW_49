...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		String url = "https://www.etsy.com/shop/RosyAccessoriesShop";
		...
		Thread.sleep(5000);
		String title = driver.findElement(By.xpath("//*[@id=\"content\"]/div[1]/div[2]/div[2]/div[2]/div[2]/div[2]/div[3]/ul/li[3]/a/div[2]/div/h2")).getText().trim().substring(0,20);
		String price = driver.findElement(By.xpath("//*[@id=\"content\"]/div[1]/div[2]/div[2]/div[2]/div[2]/div[2]/div[3]/ul/li[3]/a/div[2]/div/span/span[2]")).getText().trim(); 
		...
		String rate1 = CurrencyRate.currencyRate("USD_EUR");
		double rate01 = Double.parseDouble(rate1);
		String rate2 = CurrencyRate.currencyRate("USD_CNY");
		double rate02 = Double.parseDouble(rate2);
		String rate3 = CurrencyRate.currencyRate("USD_GBP");
		double rate03 = Double.parseDouble(rate3);
		String rate4 = CurrencyRate.currencyRate("USD_UAH");
		double rate04 = Double.parseDouble(rate4);
		String rate5 = CurrencyRate.currencyRate("USD_RUB");
